        ...
        >
          ...
          <List>
            {['Search', 'Browse'].map((text, index) => (
              <ListItem button key={text} selected={this.state.currentPage==index}>
                <ListItemIcon>{index % 2 === 0 ? <SearchIcon /> : <BrowserIcon />}</ListItemIcon>
          ...
          <Divider />
          <List>
            <ListItem button key="Settings" selected={this.state.currentPage==2}>
