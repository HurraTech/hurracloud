...
use sp_runtime::traits::{
	...
	NumberFor,IdentifyAccount,Verify,AccountIdLookup
};
...
// use pallet_contracts_rpc_runtime_api::sp_api::ContractsApi;

pub use hello_substrate;
...
impl hello_substrate::Config for Runtime {
	type AuthorityId = hello_substrate::crypto::TestAuthId;
	type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		HelloSubstrate: hello_substrate::{Pallet, Call, Event},
